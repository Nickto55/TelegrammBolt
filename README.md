...
Интерактивная консоль для мониторинга и управления ботом в реальном времени:
...
**Возможности:**
- 📊 Статистика в реальном времени (uptime, пользователи, запросы, память)
- 📋 Просмотр логов с автообновлением
- 👥 Список пользователей и их активность
- ⚙️ Команды управления (reload, clear cache, reset watcher)

**Документация:** [MONITOR_README.md](MONITOR_README.md)  
